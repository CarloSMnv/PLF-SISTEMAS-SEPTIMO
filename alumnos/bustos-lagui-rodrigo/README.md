# BUSTOS LAGUI RODRIGO

Esta carpeta es tu espacio de trabajo para subir tus actividades.

## Flujo esperado
1. Crea o cambia a tu rama: `git checkout -b actividadN-bustos-lagui-rodrigo`
2. Agrega tus archivos dentro de esta carpeta (`alumnos/bustos-lagui-rodrigo/`).
3. Haz commit con un mensaje claro: `git commit -m "Actividad N: descripcion breve"`
4. Sube tu rama: `git push origin actividadN-bustos-lagui-rodrigo`
